...
module.exports = function(app, passport) {
	...
	app.post('profile/api/players/:player', isLoggedIn, function(req, res) {
	...
	app.delete('profile/api/players/:player', isLoggedIn, function(req, res) {
		var user_id = req.user.id;
		console.log(user_id);
		var player_id = req.params.player;
		console.log(player_id);
...
// // app/routes.js FOR USER AUTHENTICATION ROUTES
// module.exports = function(app, passport) {
...
// 		// render the page and pass in any flash data if it exists
// 		res.render('register.handlebars', { message: req.flash('signupMessage') });
// 	});
